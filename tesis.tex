...
\def\autor{Guido Agustin Tripodi}
\def\tituloTesis{Contabilizacion de  repeticiones de proteinas dentro de un metagenoma}
\def\runtitulo{Contabilizacion de  repeticiones de proteinas dentro de un metagenoma}
\def\runtitle{SContabilizacion de  repeticiones de proteinas dentro de un metagenoma}
